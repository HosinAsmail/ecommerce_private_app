...
class AddProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    context.read<categoriesCubit.CategoriesCubit>().getCategories();
    return Scaffold(
              ...
              child: Padding(
                ...
                child: ListView(
                  children: [
                    ...
                    BlocBuilder<categoriesCubit.CategoriesCubit,
                        categoriesCubit.CategoriesState>(
                      builder: (context, state) {
                        if (state is categoriesCubit.GetCategoriesLoading) {
                          return const Center(
                            child: CircularProgressIndicator(),
                          );
                        } else {
                          List<CategoriesModel> categories = context
                              .read<categoriesCubit.CategoriesCubit>()
                              .categories;
                    ...
                    CustomLanguageButton(
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            if (context.read<ProductsCubit>().imageFile ==
                                null) {
                              mySnackBar(
                                  Colors.red, "خطأ", "الرجاء إضافة الصورة");
                            } else if (categoriesIdControl.text.isEmpty) {
                              mySnackBar(
                                  Colors.red, "خطأ", "الرجاء اختيار القسم");
                            } else {
